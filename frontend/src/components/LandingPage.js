...
const LandingPage = () => {
  return (
    <div className="bg-hero-page <-10+ flex h-screen w-screen snap-start items-center justify-center bg-cover bg-center  bg-no-repeat text-white ">
      <div className="rounded-xl bg-black/70 p-7 text-center">
        ...
        <div className="flex justify-center gap-4">
          <button className="rounded bg-pink-500 px-4 py-2 font-semibold text-white hover:bg-pink-700">
            Mint Now
          </button>
        </div>
      </div>
